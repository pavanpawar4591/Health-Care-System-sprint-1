 ...
 */
	...
	public void onClickFeature(View v) {
		int id = v.getId();
		switch (id) {
		/* calling ambulance button */
		case R.id.home_btn_feature1:
			startActivity(new Intent(getApplicationContext(), F1Activity.class));
			break;

		/*
		 * case R.id.home_btn_feature2: startActivity(new
		 * Intent(getApplicationContext(), F2Activity.class)); break; case
		 * R.id.home_btn_feature3: startActivity(new
		 * Intent(getApplicationContext(), F3Activity.class)); break; case
		 * R.id.home_btn_feature4: startActivity(new
		 * Intent(getApplicationContext(), F4Activity.class)); break; case
		 * R.id.home_btn_feature5: startActivity(new
		 * Intent(getApplicationContext(), F5Activity.class)); break; case
		 * R.id.home_btn_feature6: startActivity(new
		 * Intent(getApplicationContext(), F6Activity.class)); break;
		 */
		default:
			break;
		}
